...
public class TestCPU_NextFit_SJF {
    ...
    public void testCPU_FirstFit_FCFS() {
        ...
        Assert.assertEquals(processes[2].getResponseTime(), 4d, 0.01);
        Assert.assertEquals(processes[2].getWaitingTime(), 1d, 0.01);
        Assert.assertEquals(processes[2].getTurnAroundTime(), 5d, 0.01);

        Assert.assertEquals(processes[3].getResponseTime(), 5d, 0.01);
        Assert.assertEquals(processes[3].getWaitingTime(), 5d, 0.01);
        Assert.assertEquals(processes[3].getTurnAroundTime(), 8d, 0.01);

        Assert.assertEquals(processes[4].getResponseTime(), 1d, 0.01);
        Assert.assertEquals(processes[4].getWaitingTime(), 1d, 0.01);
        Assert.assertEquals(processes[4].getTurnAroundTime(), 2d, 0.01);
    }
}
